...
export function VideoHero(): React.ReactElement {
  return (
    <div className="relative w-full h-screen overflow-hidden">
      {/* Video background */}
      <video
        className="absolute inset-0 w-full h-full object-cover"
        src="/close-up-car-detailing.mp4"
        autoPlay
        loop
        muted
        playsInline
      ...
      {/* Dark gradient */}
      <div className="absolute inset-x-0 top-0 h-full bg-gradient-to-b from-black to-black/75" />
