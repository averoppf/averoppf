    ...
    <article className="bg-white min-h-screen">
      ...
      <div className="max-w-3xl mx-auto px-6 py-16 text-gray-800">
        <p className="text-xl leading-relaxed mb-8 text-gray-600 font-medium">
          One of the biggest advantages of Paint Protection Film is that it dramatically reduces the maintenance burden on your vehicle's paint. But PPF is not zero-maintenance. Caring for it correctly means it will look great and perform at full effectiveness for the duration of its life.
        </p>
        ...
        <div className="bg-black text-white rounded-2xl p-8 mt-12 flex flex-col sm:flex-row items-center justify-between gap-6">
          <div>
            ...
            <p className="text-gray-300 text-sm">The team at Avero is happy to inspect your film and advise on care or replacement. South Sydney's PPF specialists.</p>
          </div>
