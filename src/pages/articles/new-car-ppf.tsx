      ...
      <div className="max-w-3xl mx-auto px-6 py-16 text-gray-800">
        ...
        <div className="space-y-4 mb-10">
          {[
            {
              step: '1',
              title: 'Book a PPF assessment before or immediately after delivery',
              desc: 'Contact your installer as soon as you know your delivery date so they can schedule the appointment without a long wait.',
            },
            {
              step: '2',
              title: 'Inspect the vehicle on delivery',
              desc: 'Before accepting the vehicle, inspect the paint carefully under good lighting. Note any existing chips, scratches, or paint defects - even from transport or the dealership lot. These should be addressed by the dealer before your PPF goes on.',
            },
            {
              step: '3',
              title: 'Drive carefully until the appointment',
              desc: 'If there is a gap between delivery and your PPF appointment, minimise highway driving and avoid routes with heavy truck traffic or loose gravel. The film is the protection - until it is on, treat the car accordingly.',
            },
            {
              step: '4',
              title: 'Consider a light decontamination wash first',
              desc: 'Transport and storage can leave industrial fallout, dust, or contaminants on the paint. A professional wash and decontamination before PPF application ensures the film bonds to clean, bare paint.',
            },
          ].map((item) => (
