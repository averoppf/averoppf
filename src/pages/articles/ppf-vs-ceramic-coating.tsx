    ...
    <article className="bg-white min-h-screen">
      ...
      <div className="max-w-3xl mx-auto px-6 py-16 text-gray-800">
        ...
        <p className="leading-relaxed mb-4">
          The simplest way to understand the difference: <strong>PPF is physical protection, ceramic coating is chemical protection.</strong>
        </p>
        <p className="leading-relaxed mb-4">
        ...
        <div className="space-y-4 mb-12">
          {[
            {
              title: 'Choose PPF if:',
              desc: 'You drive significant highway or motorway kilometres, own a new or prestige vehicle, want long-term protection with a strong warranty, or care primarily about preserving paint condition and resale value.',
            },
            {
              title: 'Choose Ceramic Coating if:',
              desc: 'Your priority is low-maintenance upkeep, a showroom gloss finish, UV protection, or you mostly drive in suburban conditions where stone chip risk is lower and budget is a consideration.',
            },
            {
              title: 'Choose Both if:',
              desc: 'You want the best possible outcome for a new or valued vehicle and want it to look and perform as new for as long as possible. This is the approach most commonly chosen by enthusiasts, luxury car owners, and daily drivers who value their vehicle condition.',
            },
          ].map((item, i) => (
