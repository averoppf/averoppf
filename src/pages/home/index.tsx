...
import { ArticlesPreview } from '../../components/misc/ArticlesPreview';
    ...
    return (
        <div>
            <section className="relative h-[calc(100vh)] flex items-center justify-center bg-cover bg-center py-[5%]">
                <video className="absolute inset-0 w-full h-full object-cover" src="/banner.mp4" autoPlay loop muted playsInline />
                ...
                <div className="container mx-auto px-6">
                    <div className="grid md:grid-cols-2 gap-12 items-center">
                        <div>
                            ...
                            <p className="text-lg text-gray-500 leading-relaxed mb-6">At Avero, our Paint Protection Film service provides long-lasting defence against stone chips, scratches, and the wear and tear of everyday driving. We use premium, self-healing TPU film designed to preserve your vehicle original finish without altering its appearance.</p>
                ...
                <div className="container mx-auto px-6">
                    <div className="grid md:grid-cols-2 gap-12 items-center">
                        ...
                        <div>
                            ...
                            <p className="text-2xl font-medium mb-6 text-gray-300 italic leading-normal">Our ceramic coating service locks in your vehicle finish with a durable, high-gloss layer that resists dirt, UV rays, water spots, and environmental contaminants. Applied over paintwork or Paint Protection Film, it enhances depth, clarity, and surface slickness - making your car easier to clean and harder to damage.</p>
                            <p className="text-lg leading-relaxed mt-[8%]">At Avero, we use professional-grade ceramic coatings formulated to bond at the molecular level, providing long term protection. The coating creates a hydrophobic surface that repels water and grime, reducing the need for constant washing and detailing. Perfect for enthusiasts and everyday drivers alike, ceramic coating is the ultimate low-maintenance solution for keeping your vehicle looking pristine, day after day.</p>
                ...
                <div className="container mx-auto px-6">
                    <div className="grid md:grid-cols-2 gap-12 items-center">
                        <div>
                            ...
                            <p className="text-2xl font-medium mb-6 text-gray-500 italic">At Avero, we are all about helping you express your personality through your vehicle.</p>
                            <p className="text-lg text-gray-500 leading-relaxed">Whether you want something bold, subtle, or completely unique, a vinyl wrap or colour PPF is the perfect way to make your car stand out without committing to a permanent respray.</p>
                ...
                <div className="container mx-auto px-6">
                    <div className="grid md:grid-cols-2 gap-12 items-center">
                        ...
                        <div>
                            ...
                            <p className="text-lg leading-relaxed mb-6">Our team applies each tint with precision to avoid bubbles or peeling, giving your windows a smooth, factory-quality look.</p>
                            <p className="text-lg leading-relaxed">Whether you want a subtle tint or maximum privacy, we have got options to suit your style and needs.</p>
            ...
            <section id="packages" className="py-20 bg-black border-gray-900 border-t-1">
                <motion.div ref={servicesRef} animate={servicesAnimationControls} variants={servicesVariants} initial="hidden" transition={{ delay: 0.6, duration: 0.6 }} className="container mx-auto px-6">
                    ...
                    <div className="grid md:grid-cols-3 gap-8">
                        <div className="bg-black p-8 border border-gray-800 hover:border-white/50 transition-all duration-300 flex flex-col justify-between">
                            <div>
                                <div className="text-center mb-6">
                                    ...
                                    <p className="text-start text-gray-400">Our High Impact Coverage is designed for drivers looking to protect the most vulnerable impact zones without overextending their budget. It is a smart, effective introduction to PPF - perfect for those who want peace of mind on the road.</p>
                                </div>
                                <ul className="space-y-3 mb-8">
                                    <li className="flex items-center gap-3"><div className="w-2 h-2 bg-white rounded-full"></div><span className="text-gray-300">Full front bumper</span></li>
                                    <li className="flex items-center gap-3"><div className="w-2 h-2 bg-white rounded-full"></div><span className="text-gray-300">Partial bonnet</span></li>
                                    <li className="flex items-center gap-3"><div className="w-2 h-2 bg-white rounded-full"></div><span className="text-gray-300">Partial front fenders</span></li>
                                    <li className="flex items-center gap-3"><div className="w-2 h-2 bg-white rounded-full"></div><span className="text-gray-300">Mirrors</span></li>
                        ...
                        <div className="bg-gradient-to-br items-center from-white/10 to-transparent p-8 border-2 border-white relative group">
                            ...
                            <ul className="space-y-3 mb-8">
                                <li className="flex items-center gap-3"><div className="w-2 h-2 bg-white rounded-full"></div><span className="text-gray-300">Full front bumper</span></li>
                                <li className="flex items-center gap-3"><div className="w-2 h-2 bg-white rounded-full"></div><span className="text-gray-300">Full bonnet</span></li>
                                <li className="flex items-center gap-3"><div className="w-2 h-2 bg-white rounded-full"></div><span className="text-gray-300">Full front guards</span></li>
                                <li className="flex items-center gap-3"><div className="w-2 h-2 bg-white rounded-full"></div><span className="text-gray-300">Mirrors</span></li>
                                <li className="flex items-center gap-3"><div className="w-2 h-2 bg-white rounded-full"></div><span className="text-gray-300">Headlights</span></li>
                            </ul>
                        </div>
                        <div className="bg-black p-8 border border-gray-800 hover:border-white/50 transition-all duration-300 group">
                            <div className="text-center mb-6">
                                ...
                                <p className="text-start text-gray-400">For those who want nothing but the best, this full-body PPF package protects every painted surface on your vehicle. From road debris to parking mishaps, the complete vehicle package ensures your paint remains untouched and showroom-fresh.</p>
                            </div>
                            <ul className="space-y-3 mb-8">
                                <li className="flex items-center gap-3"><div className="w-2 h-2 bg-white rounded-full"></div><span className="text-gray-300">All exterior painted surfaces</span></li>
                            </ul>
                        </div>
                    </div>
                    <div className="flex items-center justify-center my-10">
                        <a className="text-black bg-white font-michroma text-[0.9rem] tracking-[0.15rem] border-2 px-6 py-4 transition-opacity hover:opacity-60 hover:cursor-pointer font-bold" href="/contact">GET A QUOTE</a>
                    </div>
                </motion.div>
            </section>
