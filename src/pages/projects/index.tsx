...
const projects: Project[] = [
    // PPF Projects
    { id: 1, title: 'BMW X4 M Competition Matte Black PPF', type: 'PPF', images: ['/car1-1.jpg', '/car1-2.jpg', '/car1-3.jpg'], description: 'This BMW X4 M Competition was finished in AveroPRO Matte, transforming its bodywork to a sleek matte black while adding full paint protection. The self-healing film guards against stone chips, swirls and wear, combining a stealthy finish with genuine defence. A striking example of BMW X4 M PPF.' },
    { id: 2, title: 'Tesla Model Y Clear Gloss PPF', type: 'PPF', images: ['/car2-1.jpg', '/car2-2.jpg', '/car2-3.jpg'], description: 'This Tesla Model Y was protected with AveroPRO HyperGloss clear PPF. Tesla\'s soft factory paint is especially prone to chips and swirl marks, so the self-healing film is a smart investment that keeps the clean factory look intact. Reliable Tesla Model Y PPF in Sydney.' },
    { id: 3, title: 'BMW Z4 M40i Clear Gloss PPF', type: 'PPF', images: ['/car3-1.jpg', '/car3-2.jpg', '/car3-3.jpg'], description: 'This BMW Z4 M40i received full AveroPRO HyperGloss clear paint protection film. The film shields the roadster\'s paint from stone chips and road debris while deepening its gloss. Quality BMW Z4 PPF for owners who want lasting protection without altering the finish.' },
    { id: 4, title: 'Lexus IS500 Clear Gloss PPF', type: 'PPF', images: ['/car4-1.jpg', '/car4-2.jpg', '/car4-3.jpg'], description: 'This Lexus IS500 was finished in AveroPRO HyperGloss self-healing clear PPF. Covering the high-impact panels, the film protects the IS500\'s paint against chips, swirls and UV fade. Premium Lexus IS500 PPF that keeps this performance sedan looking showroom fresh.' },
    { id: 5, title: 'Mercedes Benz G63 Clear Gloss PPF', type: 'PPF', images: ['/car5-1.jpg', '/car5-2.jpg', '/car5-3.jpg'], description: 'This Mercedes-Benz G63 was protected with AveroPRO HyperGloss clear PPF. An icon like the G-Wagon deserves serious protection, and the self-healing film defends its paint from stone chips and abrasions on and off road. Standout Mercedes G63 PPF.' },
    { id: 6, title: 'BMW IX M60 Clear Gloss PPF', type: 'PPF', images: ['/car6-1.jpg', '/car6-2.jpg', '/car6-3.jpg'], description: 'This BMW iX M60 received full AveroPRO HyperGloss clear paint protection film. The film guards the electric SUV\'s paint from chips, scratches and contaminants while enhancing gloss. Durable BMW iX PPF that keeps this EV flagship pristine.' },
    { id: 7, title: 'Mitsubishi Outlander Clear Gloss PPF', type: 'PPF', images: ['/car7-1.jpg', '/car7-2.jpg', '/car7-3.jpg'], description: 'This Mitsubishi Outlander was finished in AveroPRO HyperGloss clear PPF. As a family SUV covering plenty of kilometres, the Outlander benefits from PPF\'s defence against stone chips and everyday wear. Practical Mitsubishi Outlander PPF for long-term protection.' },
    { id: 8, title: 'Mercedes Benz CLA45S AMG Clear Gloss PPF', type: 'PPF', images: ['/car8-1.jpg', '/car8-2.jpg', '/car8-3.jpg'], description: 'This Mercedes-Benz CLA45S AMG was protected with AveroPRO HyperGloss self-healing clear PPF. The film shields the AMG\'s aggressive bodywork from chips and swirl marks while preserving its factory gloss. Premium Mercedes CLA45S PPF for a performance sedan.' },
    
    // Colour Wrap Projects
    { id: 9, title: 'BMX X6 M Competition Matte Black Vinyl Wrap', type: 'Colour Wrap', images: ['/car9-1.jpg', '/car9-2.jpg', '/car9-3.jpg'], description: 'This BMW X6 M Competition was transformed with a matte black vinyl wrap for a bold, stealthy new look. The wrap delivers a striking colour change that is fully reversible, letting the owner personalise the SUV\'s appearance. A clean example of BMW X6 M vinyl wrap work.' },
    { id: 10, title: 'Hyundai i30N Midnight Purple Coloured PPF', type: 'Colour Wrap', images: ['/car10-1.jpg', '/car10-2.jpg', '/car10-3.jpg'], description: 'This Hyundai i30N was finished in AveroPRO Spectral coloured PPF in a deep midnight purple. Spectral combines a full colour change with genuine paint protection, giving the i30N a unique finish plus self-healing defence against chips and wear. Custom Hyundai i30N coloured PPF.' },
    { id: 11, title: 'Porsche 911 GT3 Java Green Coloured PPF', type: 'Colour Wrap', images: ['/car11-1.jpg', '/car11-2.jpg', '/car11-3.jpg'], description: 'This Porsche 911 GT3 was finished in AveroPRO Spectral coloured PPF in a vivid Java green. Spectral pairs a head-turning colour change with real paint protection, so the GT3 gets a bespoke finish and self-healing defence in one. Bespoke Porsche 911 GT3 coloured PPF.' },
    { id: 12, title: 'Mercedes Benz GLC43 Cherry Blossom Coloured PPF', type: 'Colour Wrap', images: ['/car12-1.jpg', '/car12-2.jpg', '/car12-3.jpg'], description: 'This Mercedes-Benz GLC43 was finished in AveroPRO Spectral coloured PPF in a soft cherry blossom shade. Spectral delivers a full colour transformation with the protection of paint protection film underneath. A distinctive example of Mercedes GLC43 coloured PPF.' },
    { id: 13, title: 'BMW M4 Competition Matte Black Vinyl Wrap', type: 'Colour Wrap', images: ['/car13-1.jpg', '/car13-2.jpg', '/car13-3.jpg'], description: 'This BMW M4 Competition was transformed with a matte black vinyl wrap for an aggressive, stealthy finish. The wrap provides a bold, reversible colour change that lets the owner customise the M4\'s look. A sharp example of BMW M4 vinyl wrap work.' },
