...
export function PrivacyPolicyPage() {
  ...
  return (
    <div className="pt-[20vh] flex px-[10%] w-full flex-col">
      ...
      <div className="w-full px-[5%] py-6 text-gray-300">
        <h2 className="text-2xl font-michroma text-white mb-4">Third Parties</h2>
        <p>
      ...
      <div className="w-full px-[5%] py-6 text-gray-300">
        <h2 className="text-2xl font-michroma text-white mb-4">Disclosure of Personal Information</h2>
        <p>
      ...
      <div className="w-full px-[5%] py-6 text-gray-300">
        <h2 className="text-2xl font-michroma text-white mb-4">Security of Personal Information</h2>
        <p>
      ...
      <div className="w-full px-[5%] py-6 text-gray-300">
        <h2 className="text-2xl font-michroma text-white mb-4">Access to Your Personal Information</h2>
        <p>
          You may access the Personal Information we hold about you and to update and/or correct it, subject to certain exceptions. If you wish to access your Personal Information, please contact us in writing. Avero Solutions Pty Ltd will not charge any fee for your access request. In order to protect your Personal Information we may require identification from you before releasing the requested information.
        </p>
      </div>

      <div className="w-full px-[5%] py-6 text-gray-300">
        <h2 className="text-2xl font-michroma text-white mb-4">Maintaining the Quality of Your Personal Information</h2>
        <p>
      ...
      <div className="w-full px-[5%] py-6 text-gray-300">
        <h2 className="text-2xl font-michroma text-white mb-4">Policy Updates</h2>
        <p>
      ...
      <div className="w-full px-[5%] py-6 text-gray-300">
        <h2 className="text-2xl font-michroma text-white mb-4">Privacy Policy Complaints and Enquiries</h2>
        <p>
          If you have any queries or complaints about our Privacy Policy please contact us at:
        </p>
        <ul className="list-disc pl-6 mt-2">
          <li>Email: info@averoppf.com.au</li>
          <li>Phone: +61 415 081 546</li>
        </ul>
